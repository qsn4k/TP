...
// l5z1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cl5z1App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Cl5z1App::OnAppAbout)
...
Cl5z1App::Cl5z1App() noexcept
{
	...
	SetAppID(_T("l5z1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Cl5z1App

Cl5z1App theApp;


// Инициализация Cl5z1App

BOOL Cl5z1App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_l5z1TYPE,
		RUNTIME_CLASS(Cl5z1Doc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(Cl5z1View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений Cl5z1App
...
void Cl5z1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек Cl5z1App

void Cl5z1App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Cl5z1App::LoadCustomState()
{
}

void Cl5z1App::SaveCustomState()
{
}
